...
form Input 
	...
	sentence DirName /Users/tonhauser.1/Documents/current-research-topics/prosody-Khandeshi-Bhili/production-exp-data/Chodri-utterances/first-six/
endform
...
for i to nFiles
	...
	writeInfoLine: k
		...
		# predicates
		elsif (label$ = "aaraam" or label$ = "naangarNi" or label$ = "nindaNi" or label$ = "aaraam" or label$ = "vyaayaam")
			startTime = Get starting point... 1 'k'
			endTime = Get end point... 1 'k'	
			#writeInfoLine: label$
			select Pitch 'name$'
